          ...
          <div className="macbook-screen">
            ...
            <div className="macbook-face-one">
              ...
              <div className="macbook-display">
                {/* Welcome Screen */}
                <div className="mb-welcome-screen">
                  {/* Subtle grid lines */}
                  <div className="mb-grid" />
                  {/* Glow orb */}
                  <div className="mb-glow-orb" />
                  {/* Content */}
                  <div className="mb-welcome-content">
                    <div className="mb-welcome-badge">✦ AI Powered</div>
                    <div className="mb-welcome-title">Welcome to</div>
                    <div className="mb-welcome-brand">JobMitra</div>
                    <div className="mb-welcome-tagline">Find your way.</div>
                    <div className="mb-welcome-divider" />
                    <div className="mb-welcome-sub">Smart Hiring · Fast Matching</div>
                  </div>
                  {/* Bottom bar */}
                  <div className="mb-welcome-bar">
                    <span className="mb-bar-dot" />
                    <span className="mb-bar-text">jobmitra.com</span>
                    <span className="mb-bar-status">● Online</span>
                  </div>
                </div>
